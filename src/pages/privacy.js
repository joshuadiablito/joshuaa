  ...
  return (
    <Fragment>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Joshua Anderson.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Joshua Anderson, accessible
              from
              <a href="https://www.joshuaa.uk" target="_blank" rel="noreferrer">
                https://www.joshuaa.uk
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            By email: <a href="mailto:privacy@joshuaa.uk">privacy@joshuaa.uk</a>
          </li>
        </ul>
      </div>
    </Fragment>
